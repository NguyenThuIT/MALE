...
path = 'C:/Users/IT/Desktop/MALE_LamThanhTai_15110121/File Project/DATANaive-Bayes-Classifier/'
...
# Ma trận này là ma trận sparse nên chúng ta sẽ sử dụng hàm  scipy.sparse.coo_matrix.
nwords = 2500
...
# Đọc training data và test data, sử dụng class MultinomialNB trong sklearn để
# xây dựng mô hình và dự đoán đầu ra cho test data.
